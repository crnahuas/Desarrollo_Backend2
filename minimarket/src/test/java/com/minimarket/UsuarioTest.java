...
public class UsuarioTest {
    ...
    public void testCrearUsuario() {
        ...
        usuario.setEmail("admin@minimarket.cl");
        ...
        assertEquals("Principal", usuario.getApellido());
        assertEquals("admin@minimarket.cl", usuario.getEmail());
        assertEquals("Av. Central 123", usuario.getDireccion());
